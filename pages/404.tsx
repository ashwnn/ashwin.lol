    ...
    return (
        <Container>
            <Head>
                ...
                <meta name="tite" content="404: Not Found" />
            ...
            <div className={`flex flex-col items-center justify-center h-screen bg-[#0102AC] text-[#ABABAD] ${p2p.className} px-6`}>
                ...
                <div className="items-start max-w-4xl mt-10 leading-loose">
                    ...
                    <br />
                    <p>
                        Error: <span className="block md:hidden"></span> 0E{"  "}:{"  "}016F{"  "}:{"  "}BFF9B3D4
                    </p>
                </div>
                <br /><br />
