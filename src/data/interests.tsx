...
export const interests: Interest[] = [
    ...
    {
        title: 'Hiking',
        description: 'Check out the hikes I did across BC and AB',
        link: '/about/interests/hiking',
        slug: 'hiking',
        icon: (
            <svg className="h-20 w-20 mb-3 text-neutral-400" viewBox="0 0 24 24" fillOpacity={0} xmlns="http://www.w3.org/2000/svg">
    ...
    {
        title: 'Travelling',
        description: 'From road trips to international, I love going to new places and experiencing new cultures in different countries.',
        link: '/about/interests/travelling',
        slug: 'travelling',
        icon: (
            <svg
                className="h-20 w-20 mb-3 text-neutral-400"
                viewBox="0 0 24 24"
                fill="none"
